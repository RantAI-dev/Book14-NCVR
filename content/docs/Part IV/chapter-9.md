...
weight: 2400
title: "Chapter 9"
description: "Root Finding and Nonlinear Sets of Equations"
icon: "article"
...
<div class="row justify-content-center">
    <div class="rounded p-4 position-relative overflow-hidden border-1 text-center" style="width: 70%">
        {{< figure src="/images/pqQDe4beUu67RvW3raYP-4sHjedt7slf2r02h2zU8-v1.png" >}}
        <p>**Figure 9.3.1.** Stagnation of interpolation-based root-finding methods in a highly nonlinear interval.</p>
    </div>
</div>
...
<div class="row justify-content-center">
    <div class="rounded p-4 position-relative overflow-hidden border-1 text-center" style="width: 50%">
        {{< figure src="/images/pqQDe4beUu67RvW3raYP-fj1DBiUglO64quI8jnSZ-v1.png" >}}
        <p>**Figure 9.5.2:** Newton fractal for the polynomial $f(z)=z^3-1$ generated using the iteration defined in Equation (9.5.19). Each color corresponds to the basin of attraction of one of the three cubic roots of unity, while brightness indicates the number of iterations required for convergence. The intricate boundaries between colored regions reveal the fractal structure of the basin separatrices, illustrating the sensitive dependence of Newton’s method on initial conditions in the complex plane.</p>
    </div>
</div>
